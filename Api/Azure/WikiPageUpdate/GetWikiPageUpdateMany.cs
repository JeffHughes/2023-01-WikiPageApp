...
{   
    ...
    [OpenApiOperation(operationId: "GetWikiPageUpdateWithLinq", tags: new[] { "wiki-page-update" })]
    [Function("GetWikiPageUpdateManyWithLinq")]
    public async Task<IActionResult> GetWikiPageUpdateManyWithLinq( 
    [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "WikiPageUpdates")]
        HttpRequestData req )
    { 
    ...
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(List<Model.WikiPageUpdate>), Description = "The OK response message containing a JSON result.")]        
    [OpenApiOperation(operationId: "GetWikiPageUpdateWithOData", tags: new[] { "wiki-page-update" })]
    [Function("GetWikiPageUpdateManyWithOdata")]
    public async Task<IActionResult> GetWikiPageUpdateManyWithOData(
    [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "WikiPageUpdates/OData")]
        HttpRequestData req )
    { 
        // TODO: clean this up to be common/shared functionality and possibly use 3rd party lib to auto-extract to class/struct
        var functionContext = req.FunctionContext;
        ...
        var results = await ConfigUtils.GetResultsFromODataEFContextObject(queryParameters, _context.WikiPageUpdate.OData());
        return new OkObjectResult(results);
    } 
